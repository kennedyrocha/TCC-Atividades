...
A Enoc (Rede em Chip Expansível) é uma topologia de rede sugerida por Ivan Luiz Pedroso (2018), que permite comunicação de elementos de processamento de um chip, porém esse diálogo pode se dar tanto de elementos num chip (Intra-Chip) quanto com elementos em outro chip (Inter-Chip).
