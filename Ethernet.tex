...
\begin{center}
	...
	\centering
		\begin{tabular}{ | c | c | c | c | }
			...
			\hline
			\multirow{8}{*}{\begin{sideways}\parbox{2cm}{\centering Pacote}\end{sideways}}
				& & 7 Bytes & Preâmbulo \\ \cline{3-4}
				& & 1 Byte & SDF \\ \cline{2-4}
				& \multirow{6}{*}{\begin{sideways}\parbox{2cm}{\centering Frame}\end{sideways}}
					& 6 Bytes & Endereço de Destino \\ \cline{3-4}
					& & 6 Bytes & Endereço de Origem \\ \cline{3-4}
					& & 2 Bytes & Tamanho / Tipo \\ \cline{3-4}
					& & 46 a (1500 ou 1504 ou 1982) Bytes & Dados Cliente MAC \\ \cline{3-4}
					& & 4 Bytes & Sequência de checagem de frame \\ \cline{3-4}
			\hline	
		\end{tabular}
		\centering
